...
import com.collegecapstoneteam1.cookingapp.databinding.ItemRecipePagerBinding

class RecipePagerAdapter : ListAdapter<Recipe, RecipePagerAdapter.RecipeViewHolder>(RecipeDiffCallback) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecipeViewHolder {
        return RecipeViewHolder(
            ItemRecipePagerBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }
    ...
    inner class RecipeViewHolder(
        private val binding: ItemRecipePagerBinding
